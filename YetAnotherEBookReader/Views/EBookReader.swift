...
struct EBookReader: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        ...
        if bookFormat == CalibreBook.Format.EPUB && bookReader == ReaderType.FolioReader {
            ...
            let epubReaderContainer = EpubFolioReaderContainer(withConfig: readerConfiguration, folioReader: folioReader, epubPath: bookURL.path, removeEpub: false)
